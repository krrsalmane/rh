...
router.get('/:id/document', authorize('super_admin', 'hr_agent', 'manager', 'employee'), leavesController.getLeaveRequestDocument);
router.get('/:id', authorize('super_admin', 'hr_agent', 'manager', 'employee'), leavesController.getLeaveRequestById);
router.post('/', authorize('super_admin', 'hr_agent', 'manager', 'employee'), upload.single('supportingDocument'), validate(CreateLeaveRequestSchema), leavesController.createLeaveRequest);
