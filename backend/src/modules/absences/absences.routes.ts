...
router.get('/', authorize('super_admin', 'hr_agent', 'employee'), absencesController.getAbsences);
router.get('/analytics', authorize('super_admin', 'hr_agent'), absencesController.getAnalytics);
router.get('/:id', authorize('super_admin', 'hr_agent', 'employee'), absencesController.getAbsenceById);
router.post('/', authorize('super_admin', 'hr_agent', 'employee'), validate(CreateAbsenceSchema), absencesController.createAbsence);
