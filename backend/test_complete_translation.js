// Test complete translation with fixed logic
const TRANSLATIONS = {
  fr: {
...
function testCompleteTranslation() {
  console.log('🧪 Testing Complete Document Translation...\n');
  
  const fullAttestation = `ATTESTATION DE TRAVAIL
...
2026/05/Fait à ____________, le 12`;
  ...
  console.log('\n✅ Complete translation test finished!');
}
