// Test the improved attestation translation
const TRANSLATIONS = {
  fr: {
...
function testAttestationTranslation() {
  console.log('🧪 Testing Attestation Translation...\n');
...
2026/05/Fait à ____________, le 12`;
  ...
  languages.forEach(lang => {
    ...
    const translated = translateText(attestationText, lang);
