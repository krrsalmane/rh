    ...
    children: [
      {
        ...
        children: [
          ...
          { path: ROUTES.ABSENCES, element: <RoleGuard roles={['super_admin', 'hr_agent', 'employee']}><AbsencesPage /></RoleGuard> },
          { path: ROUTES.ABSENCE_DETAIL, element: <RoleGuard roles={['super_admin', 'hr_agent', 'employee']}><AbsenceDetailPage /></RoleGuard> },
