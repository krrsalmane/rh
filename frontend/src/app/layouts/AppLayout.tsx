  ...
  return (
    <div className="flex h-screen overflow-hidden transition-colors bg-gray-50 text-gray-900">
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden bg-white">
        {/* ── Topbar ── */}
        <header className="h-14 border-b flex items-center justify-between px-6 flex-shrink-0 z-40 transition-colors bg-white border-gray-100">
          ...
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-base font-semibold transition-colors text-gray-800">
              {pageTitle}
            </h2>
          </div>
            ...
            <div className="relative pl-3 ml-1 border-l border-gray-200">
              ...
              >
                <div className="text-right hidden sm:block">
                  <p className="text-sm font-semibold leading-none transition-colors text-gray-800">
                    {user?.email}
                  </p>
                </div>
                ...
                <ChevronDown className="w-4 h-4 transition-colors text-gray-400" />
              </button>

              {isMenuOpen && (
                <>
                  <div className="fixed inset-0 z-40" onClick={() => setIsMenuOpen(false)} />
                  <div className="absolute right-0 top-full mt-2 w-56 rounded-xl shadow-xl border p-2 z-50 transition-all bg-white border-gray-100">
        ...
        {/* ── Main content ── */}
        <main className="flex-1 overflow-y-auto p-8 transition-colors bg-slate-50/50">
